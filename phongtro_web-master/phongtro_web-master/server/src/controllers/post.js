...
export const createNewPost = async (req, res) => {
    try {
        ...
        user_historyService.createNewUser_historyService(id, "Create new post", response.postId);
...
export const deletePost = async (req, res) => {
    ...
    try {
        ...
        user_historyService.createNewUser_historyService(id, "Delete post", postId);
