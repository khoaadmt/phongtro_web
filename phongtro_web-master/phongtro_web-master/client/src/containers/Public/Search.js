...
const Search = () => {
    ...
    return (
        <>
            <div className="p-[10px] w-3/5 my-3 bg-gray-800 rounded-lg flex flex-row lg:flex-row flex-wrap items-center justify-around gap-2">
                <span
                ...
                <button
                    ...
                    className="outline-none py-2 px-4 flex-1 bg-blue-500 text-[13.3px] flex items-center justify-center gap-2 text-white font-medium">
                    <FiSearch />
                    Tìm kiếm
                </button>
            </div>
