...
import { BoxInfo, RelatedPost, VoteAndComment, VoteOption, QuestionAndAnswer, Report } from "../../components";
                ...
                <div className="bg-white rounded-md shadow-md p-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-sm bg-red-500 text-white p-2 w-fit">
                            <MdReportProblem />
