    ...
    return (
        <div onClick={e => e.stopPropagation()} className='p-8 bg-white rounded-md min-w-[600px]'>
            <div className='flex flex-col gap-2 border-b pb-4'>
                <span className='font-bold'>Hãy chia sẻ cảm nhận của bạn về bài viết</span>
            ...
            <div className='flex flex-col gap-4 mt-2'>
                <span className='font-bold'>Bạn thấy bài viết này như thế nào</span>
            ...
            <button
                type='button'
                className='py-2 w-full mt-8 font-semibold text-white bg-red-500  rounded-md'
