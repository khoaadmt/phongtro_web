...
const Intro = () => {
    ...
    return (
        <div className="w-5/6 bg-white rounded-md shadow-md  mt-10 p-4 gap-4 flex-col flex justify-center items-center">
            ...
            <p>{text.answer}</p>
            <Button text="Đăng tin ngay" bgColor="bg-blue-500 hover:bg-blue-500" textColor="text-white" px="px-6" />
